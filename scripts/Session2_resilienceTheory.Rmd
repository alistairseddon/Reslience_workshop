...
# Use the lagged coordinate embedding technique as another way to show that the system is deterministic
...
a) Use the code above to experiment how changing the different the parameters (e.g. growth rates) influences the shape of the growth. What happens when the starting value is greater than the carrying capacity?
