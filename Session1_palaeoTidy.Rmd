...
1. Download chron control tibble for a given site
2. Rewrite this file in the appropriate format for BACON
3. Run the age modelling algorithm
4. Extract the age and depth information
5. Append to the tibble
